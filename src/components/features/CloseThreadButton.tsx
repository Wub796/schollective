...
export function CloseThreadButton({ requestId }: CloseThreadButtonProps) {
  ...
  return (
    <button
      onClick={handleClose}
      disabled={loading}
      className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-[rgba(255,80,80,0.15)] bg-[rgba(255,80,80,0.05)] text-[0.65rem] font-bold uppercase tracking-wider text-[#ff6b6b] hover:bg-[rgba(255,80,80,0.1)] disabled:opacity-50 btn-action-danger"
