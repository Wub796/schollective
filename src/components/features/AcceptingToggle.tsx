  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${accepting ? "rgba(120,220,120,0.2)" : "rgba(250, 250, 249, 0.1)"}`,
        borderRadius: "100px",
    ...
    >
      ...
      <span style={{
        ...
        height: "6px",
        borderRadius: "50%",
        background: accepting ? "rgba(120,220,120,0.8)" : "rgba(250, 250, 249, 0.2)",
      ...
      <span style={{
        ...
        color: accepting ? "rgba(250, 250, 249, 0.5)" : "rgba(250, 250, 249, 0.25)",
