  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${accepting ? "rgba(120,220,120,0.2)" : "rgba(255,255,255,0.1)"}`,
        borderRadius: "100px",
        background: accepting ? "rgba(120,220,120,0.05)" : "rgba(255,255,255,0.03)",
    ...
    >
      ...
      <span style={{
        ...
        height: "6px",
        borderRadius: "50%",
        background: accepting ? "rgba(120,220,120,0.8)" : "rgba(255,255,255,0.2)",
      ...
      <span style={{
        ...
        color: accepting ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.25)",
