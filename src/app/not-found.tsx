    ...
    <div style={{ minHeight: "100vh", background: "#080c14", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 520, width: "100%", display: "flex", flexDirection: "column", gap: "2rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <span style={{ fontSize: "0.55rem", fontWeight: 700, letterSpacing: "0.38em", textTransform: "uppercase", color: "rgba(15, 23, 42, 0.32)", fontFamily: "var(--font-sans)" }}>404 — Not Found</span>
        </div>

        {/* Number */}
        <div className="font-display" style={{ fontSize: "clamp(6rem, 18vw, 12rem)", fontWeight: 900, color: "rgba(15, 23, 42, 0.06)", letterSpacing: "-0.06em", lineHeight: 1, userSelect: "none" }}>
          404
        </div>
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <Link href="/login" style={{ textDecoration: "none" }}>
            <div style={{ padding: "0.85rem 2rem", background: "transparent", color: "rgba(15, 23, 42, 0.5)", border: "1px solid rgba(15, 23, 42, 0.12)", borderRadius: "100px", fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", fontFamily: "var(--font-sans)", cursor: "pointer" }}>
              Sign In
            </div>
          </Link>
        </div>
