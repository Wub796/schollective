...
export default async function ProfessorsPage({ searchParams }: ProfessorsPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[var(--navy)] relative overflow-x-hidden">
      ...
      <main className="relative z-10 py-12 lg:py-24">
        <div className="content-container">
          ...
          <header className="mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-[var(--text-muted)] text-lg lg:text-xl leading-relaxed max-w-2xl font-light">
          ...
          {professors && professors.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
              {professors.map((prof) => (
            ...
            <div className="bg-[rgba(17,34,64,0.3)] border border-dashed border-[rgba(155,175,192,0.15)] rounded-[40px] p-16 lg:p-24 text-center backdrop-blur-sm animate-in zoom-in-95 duration-700">
              ...
              <p className="text-[var(--text-muted)] max-w-md mx-auto mb-10 text-lg leading-relaxed font-light">
          ...
          <footer className="mt-32 pt-16 border-t border-[rgba(155,175,192,0.1)] text-center">
            ...
            <div className="text-[var(--text-muted)] text-xs uppercase tracking-widest opacity-50 font-medium">
