  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <motion.div
        ...
        style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "1px", background: "linear-gradient(90deg, transparent, rgba(250, 250, 249, 0.8), transparent)", transformOrigin: "center" }}
      />
    </div>
  );
}
      ...
      >
        ...
        <motion.div variants={fadeUp}>
          <Link href="/" style={{ textDecoration: "none" }}>
            <span className="font-display" style={{ fontSize: "1.25rem", fontWeight: 800, color: "#fafaf9", letterSpacing: "-0.02em" }}>Schollective</span>
          </Link>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          ...
          {step === "request" && sent && (
            <motion.div key="sent" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
              style={{ display: "flex", flexDirection: "column", gap: "1.5rem", padding: "2rem", border: "1px solid rgba(250, 250, 249, 0.08)", borderRadius: "16px", background: "rgba(250, 250, 249, 0.02)" }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "rgba(120,220,120,0.8)", flexShrink: 0 }} />
                <span style={{ fontSize: "0.55rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(250, 250, 249, 0.4)", fontFamily: "var(--font-sans)" }}>Link Sent</span>
              </div>
              <p style={{ fontSize: "0.85rem", color: "rgba(250, 250, 249, 0.45)", lineHeight: 1.8, fontFamily: "var(--font-sans)" }}>
        ...
        <motion.div variants={fadeUp}>
          <Link href="/login" style={{ textDecoration: "none" }}>
            <span style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(250, 250, 249, 0.3)", fontFamily: "var(--font-sans)" }}>
              ← Back to Login
            </span>
          </Link>
        </motion.div>
