        ...
        <div style={{
          ...
          <header style={{ marginBottom: "2.5rem" }}>
            ...
            <h1 className="font-display" style={{
              ...
              Application Under{" "}
              <em style={{ fontStyle: "italic", color: "rgba(15, 23, 42, 0.3)" }}>Review</em>
            </h1>
            <p style={{
              fontSize: "0.82rem", color: "rgba(15, 23, 42, 0.5)",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "0.875rem" }}>
              <Info size={15} style={{ color: "rgba(37, 99, 235, 0.4)", marginTop: "0.1rem", flexShrink: 0 }} />
              <div>
                <h3 style={{
