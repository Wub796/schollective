        ...
        <div className="w-full max-w-[760px] mx-auto flex flex-col items-center text-center">
          <FadeIn className="w-full flex flex-col items-center">
            ...
            <h1 className="font-display text-[clamp(2.8rem,6.5vw,5rem)] font-black tracking-[-0.04em] leading-[1.05] mb-8 text-slate-900 dark:text-slate-100 text-center">
              Engineered for<br />
              <em className="italic font-light text-indigo-600 dark:text-indigo-400">academic excellence.</em>
            </h1>
          </FadeIn>
        ...
        <div className="w-full max-w-[920px] mx-auto">
          <FadeIn>
            <h2 className="font-display text-[clamp(2.2rem,4vw,3.5rem)] font-black tracking-[-0.04em] leading-[1.05] mb-14 text-slate-900 dark:text-slate-100">
              Everything you need,<br /><em className="italic font-light text-indigo-600 dark:text-indigo-400">nothing you don&apos;t.</em>
            </h2>
          </FadeIn>
            ...
            {FEATURES.map((f, i) => (
              <FadeIn key={f.t} delay={i * 0.05}>
                <div className="p-8 border border-slate-200/70 dark:border-slate-800 rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-md h-full transition-all duration-300 hover:shadow-md hover:border-indigo-600 text-left flex flex-col">
                  <div className="w-12 h-12 rounded-xl bg-indigo-600/10 dark:bg-indigo-500/15 border border-indigo-600/25 dark:border-indigo-500/30 flex items-center justify-center mb-6">
                    <f.i size={20} className="text-indigo-600 dark:text-indigo-400" />
                  </div>
                  <h3 className="font-display text-[1.15rem] font-bold text-slate-900 dark:text-slate-100 tracking-[-0.02em] mb-2">{f.t}</h3>
                  <p className="text-[0.88rem] text-slate-600/90 dark:text-slate-300 leading-relaxed font-sans mt-auto">{f.d}</p>
                </div>
              </FadeIn>
            ))}
          </div>
          ...
          <FadeIn>
            <div className="border border-slate-200/70 dark:border-slate-800 rounded-3xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm w-full px-8 md:px-16" style={{ paddingTop: "6.5rem", paddingBottom: "6.5rem" }}>
              <h2 className="font-display font-black text-[clamp(1.8rem,2.8vw,2.4rem)] tracking-[-0.03em] text-slate-900 dark:text-slate-100 mb-6">
                Safety by <em className="italic font-light text-indigo-600 dark:text-indigo-400">Design.</em>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div className="p-7 bg-slate-50/80 dark:bg-slate-800/60 rounded-xl border border-slate-200/60 dark:border-slate-700/60 flex flex-col gap-2">
                  <ShieldCheck size={22} className="text-indigo-600 dark:text-indigo-400" />
                  <div className="font-display font-bold text-[1.1rem] text-slate-900 dark:text-slate-100">Edge Guards</div>
                  <p className="text-[0.88rem] text-slate-600/90 dark:text-slate-300 leading-relaxed font-sans mt-1">
                ...
                <div className="p-7 bg-slate-50/80 dark:bg-slate-800/60 rounded-xl border border-slate-200/60 dark:border-slate-700/60 flex flex-col gap-2">
                  ...
                  <div className="font-display font-bold text-[1.1rem] text-slate-900 dark:text-slate-100">JWT Integrity</div>
                  <p className="text-[0.88rem] text-slate-600/90 dark:text-slate-300 leading-relaxed font-sans mt-1">
            ...
            <div className="border border-indigo-300/50 dark:border-indigo-500/30 rounded-3xl bg-indigo-50/50 dark:bg-indigo-950/20 backdrop-blur-md flex flex-col items-center gap-12 text-center w-full px-8 md:px-16" style={{ paddingTop: "6.5rem", paddingBottom: "6.5rem" }}>
              <div className="flex flex-col gap-5">
                <h2 className="font-display font-black text-[clamp(2rem,3vw,2.8rem)] tracking-[-0.04em] text-slate-900 dark:text-slate-100 leading-tight">
                  Ready to experience <em className="italic font-light text-indigo-600 dark:text-indigo-400">Schollective?</em>
                </h2>
