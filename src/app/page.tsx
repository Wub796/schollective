...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    // 1. Mouse Parallax System (Only for non-touch)
    ...
    <div className="relative">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center px-4 sm:px-6 lg:px-8 pt-32 pb-24 overflow-hidden perspective-[1200px]">
        <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="absolute inset-0 z-[-1] bg-[radial-gradient(ellipse_80%_60%_at_70%_40%,rgba(212,146,42,0.07),transparent_70%),radial-gradient(ellipse_60%_80%_at_20%_70%,rgba(61,122,107,0.08),transparent_65%),linear-gradient(180deg,#0B1628,#0D1E35)] pointer-events-none -mx-4 sm:-mx-6 lg:-mx-8">
          ...
          <div className="w-[min(480px,40vw)] z-[2] hidden lg:block animate-in fade-in slide-in-from-bottom-12 delay-200 duration-1000 preserve-3d">
            <div ref={clusterRef} className="relative h-[480px] preserve-3d transition-transform duration-500 ease-out">
              ...
              <div data-depth="18" className="absolute top-[4%] right-[-10px] w-[210px] bg-[rgba(17,34,64,0.82)] border border-[rgba(212,146,42,0.14)] rounded-[18px] p-5 backdrop-blur-3xl shadow-2xl transition-all duration-500 hover:border-[rgba(212,146,42,0.3)] z-[2]">
                ...
                <div className="w-10 h-10 rounded-full bg-[rgba(212,146,42,0.18)] text-[var(--amber-light)] flex items-center justify-center font-serif text-lg mb-3">RK</div>
      ...
      {/* Stats Band */}
      <div className="relative z-10 bg-[rgba(17,34,64,0.55)] border-y border-[rgba(212,146,42,0.09)] px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* CTA Section */}
      <section className="relative text-center px-4 sm:px-6 lg:px-8 py-32 overflow-hidden bg-[radial-gradient(ellipse_70%_70%_at_50%_50%,rgba(212,146,42,0.055),transparent_70%)]">
      ...
      {/* Footer */}
      <footer className="relative z-10 px-4 sm:px-6 lg:px-8 pt-16 pb-12 bg-[rgba(11,22,40,0.9)] border-t border-[rgba(155,175,192,0.07)]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-12 pb-12 border-b border-[rgba(155,175,192,0.07)]">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 list-none p-0 text-sm text-[var(--text-muted)]">
