      ...
      >
        ...
        <footer className="w-full border-t border-[var(--border)] bg-[var(--bg-base)]">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-20 md:py-28 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12 text-left">
            <FadeIn delay={0} className="md:col-span-2 flex flex-col items-start gap-5">
                ...
                {[
                  ...
                  const inner = (
                    <div className="flex items-center gap-3 text-left group">
                      <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "var(--accent-dim)", border: "1px solid var(--accent-glow)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }} className="transition-all duration-200 group-hover:scale-105">
